...
declare const _default: <ParamList extends unknown>() => import("@react-navigation/native").TypedNavigator<ParamList, TabNavigationState<Record<string, object | undefined>>, BottomTabNavigationOptions, BottomTabNavigationEventMap, typeof BottomTabNavigator>;
